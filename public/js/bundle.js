...
var showAlert = function showAlert(type, msg) {
  ...
  var ms = msg;
  var ty = type;
  var markup = "<div class=\"alert alert--".concat(ty, "\">").concat(ms, "</div>");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            console.log("err", _context.t0); // showAlert('error',err.data.message);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2F5YW5hajkiLCJhIjoiY2tqY2RxZ29wN3RrcjJybGI1bjVvZnk5eiJ9.QldglBjuLdkfnbJ8MhPcgg';
...
},{}],"stripes.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51I5RJpA2QBWwLr63K8MjCOImXz60mWvweIpDn0USEv0EAfma9EvmMMO6UstJszU6dP9l42Q7oWsTaRIvUuOCZwr60046vbWCdG'); // 1) Get checkout session from API
...
var logOutClass = document.querySelector('.nav__el--logout');
var userData = document.querySelector('.form-user-data');
var userPasswordform = document.querySelector('.form-user-password'); // const bookBtn = document.querySelector('book-tour');

var bookBtn = document.querySelector('button');
var locations = [{
...
if (logOutClass) logOutClass.addEventListener('click', _login.logout);
...
if (userData) {
  userData.addEventListener('click', function (e) {
    ...
    form.append('photo', document.getElementById('here').files[0]); // const email=document.getElementById('email').value;
...
if (userPasswordform) {
  userPasswordform.addEventListener('click', /*#__PURE__*/function () {
